  ...
  return (
    ...
    <div className='Main-page'>
      <div className='Category_list'>
        <h2 className='topic-category mt-5 mb-5 text-center'>BROWSE BY CATEGORY</h2>
        <div className='Main-page-h3 d-flex justify-content-between flex-wrap'>
        <NavLink to="/categories/electronics" ><h2 className='text-center'>Electronics</h2><a href=''><img className="item" src="https://images.unsplash.com/photo-1611078489935-0cb964de46d6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bGFwdG9wc3xlbnwwfHwwfHw%3D&w=1000&q=80" width={"250px"} height={"188px"} alt="electronics"/></a></NavLink>
      ...
      <div className='Featured_brands'>
        <h2 className='topic-category mt-5 mb-5'>YOU MAY BE INTERESTED </h2>
        <div className='Main-page-h3 d-flex justify-content-around flex-wrap mb-5'>
